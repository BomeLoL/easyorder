...
class BarNavigationClient extends StatefulWidget {
  const BarNavigationClient({super.key, this.index,      
      required this.info,
      required this.menu,
          ...
          builder: (context, cartController,navController,child) {
            return BottomNavigationBar(
              ...
              onTap: (int clickedIndex) async {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context){return Factura(info: widget.info,idMesa: widget.idMesa,menu: widget.menu,restaurante: widget.restaurante);}));
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) {
                        return walletView(idMesa: widget.idMesa,info: widget.info,menu: widget.menu,restaurante: widget.restaurante);
                      },
                    ),
                  ).then((_){setState(() {
